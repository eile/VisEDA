...
BOOST_AUTO_TEST_CASE(requestEvent)
{
    const zeq::uint128_t eventType( 42, 17 );
...
{
    zeq::vocabulary::Echo echo1;
    echo1.setMessage( "Test Message" );
    const zeq::vocabulary::Echo echo2( echo1 );
    BOOST_CHECK_EQUAL( echo1.getMessageString(), echo2.getMessageString( ));
}
